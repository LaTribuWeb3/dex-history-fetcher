 ...
 */
function computeLiquiditySushiV2PoolAvg(fromReserve, toReserve, targetSlippage) {
    if(fromReserve == 0) {
        return 0;
    }
...
module.exports = { getAvailableSushiswapV2, computeSushiswapV2Price, computeLiquiditySushiV2Pool, getSushiV2DataforBlockInterval, computeLiquiditySushiV2PoolAvg};
