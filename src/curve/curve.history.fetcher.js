...
function getCurveContract(fetchConfig, web3Provider) {
    ...
    switch(fetchConfig.abi.toLowerCase()) {
        ...
        case 'cryptov2':
            ...
            break;
        case 'curvestable':
            curveContract = new Contract(fetchConfig.poolAddress, curveConfig.curveStableSwapNGAbi, web3Provider);
            break;
        default: 
    ...
    switch(fetchConfig.abi.toLowerCase()) {
        ...
        case 'curvestable':
            topics = [
                ...
                curveContract.filters.RampA().topics[0],
                curveContract.filters.StopRampA().topics[0],
                curveContract.filters.ApplyNewFee().topics[0],
                curveContract.filters.SetNewMATime().topics[0],
            ];
            break;
        default: 
            throw new Error(`Unknown abi: ${fetchConfig.abi}`);
